...
ANALYTIC_CACHE_USER_VERSION_PREFIX = (
    f"{ANALYTIC_CACHE_VERSION_PREFIX}:user"
)

ANALYTIC_CACHE_REVIEW_VERSION_PREFIX = (
    f"{ANALYTIC_CACHE_VERSION_PREFIX}:review"
)
...
ANALYTIC_CACHE_MANAGEMENT_VERSION_PREFIX = (
    f"{ANALYTIC_CACHE_VERSION_PREFIX}:management"
)
...
ANALYTIC_CACHE_DETAIL_PREFIX = (
    f"{ANALYTIC_CACHE_PREFIX}:detail"
)
...
ANALYTIC_CACHE_LIST_PREFIX = (
    f"{ANALYTIC_CACHE_PREFIX}:list"
)

ANALYTIC_CACHE_MANAGEMENT_PREFIX = (
    f"{ANALYTIC_CACHE_PREFIX}:management:list"
)
...
ANALYTIC_CACHE_USER_PREFIX = (
    f"{ANALYTIC_CACHE_PREFIX}:user"
)

ANALYTIC_CACHE_REVIEW_PREFIX = (
    f"{ANALYTIC_CACHE_PREFIX}:review"
)
