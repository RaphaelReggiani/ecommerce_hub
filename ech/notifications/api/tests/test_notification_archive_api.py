...
class NotificationArchiveApiTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse(
            "notifications-api:notification-archive",
    ...
    def test_archive_returns_unauthorized_for_unauthenticated_user(self):
        """Reject archive operation for unauthenticated users."""
    ...
    def test_archive_successfully_for_owner(self):
        """Allow notification owner to archive notification."""
        ...
        self.assertIsNotNone(self.notification.lifecycle.archived_at)

    def test_archive_rejects_other_customer(self):
        """Reject archive when another customer attempts the operation."""
    ...
    def test_archive_allows_staff(self):
        """Allow staff users to archive notifications."""
    ...
    def test_archive_is_idempotent_when_already_archived(self):
        """Ensure archive operation is idempotent."""
    ...
    def test_archive_returns_404_for_nonexistent_notification(self):
