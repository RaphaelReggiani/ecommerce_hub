...
from ech.payments.constants.constants import (
    ...
    LABEL_EVENT_TYPE_CHOICE_CREATED,
    LABEL_EVENT_TYPE_CHOICE_STARTED,
    LABEL_EVENT_TYPE_CHOICE_AUTHORIZED,
    LABEL_EVENT_TYPE_CHOICE_CAPTURED,
    LABEL_EVENT_TYPE_CHOICE_FAILED,
    LABEL_EVENT_TYPE_CHOICE_CANCELLED,
    LABEL_EVENT_TYPE_CHOICE_REFUNED_REQUESTED,
    LABEL_EVENT_TYPE_CHOICE_REFUND_FAILED,
    LABEL_EVENT_TYPE_CHOICE_REFUND_CANCELLED,
    LABEL_EVENT_TYPE_CHOICE_PARTIALLY_REFUNDED,
    LABEL_EVENT_TYPE_CHOICE_REFUNDED,
)
...
class PaymentEvent(models.Model):
    ...
    TYPE_PROCESSING_STARTED = "processing_started"
    TYPE_AUTHORIZED = "authorized"
    TYPE_CAPTURED = "captured"
    TYPE_FAILED = "failed"
    TYPE_CANCELLED = "cancelled"
    TYPE_REFUND_REQUESTED = "refund_requested"
    TYPE_REFUND_FAILED = "refund_failed"
    TYPE_REFUND_CANCELLED = "refund_cancelled"
    TYPE_PARTIALLY_REFUNDED = "partially_refunded"
    TYPE_REFUNDED = "refunded"

    EVENT_TYPE_CHOICES = [
        (TYPE_CREATED, LABEL_EVENT_TYPE_CHOICE_CREATED),
        (TYPE_PROCESSING_STARTED, LABEL_EVENT_TYPE_CHOICE_STARTED),
        (TYPE_AUTHORIZED, LABEL_EVENT_TYPE_CHOICE_AUTHORIZED),
        (TYPE_CAPTURED, LABEL_EVENT_TYPE_CHOICE_CAPTURED),
        (TYPE_FAILED, LABEL_EVENT_TYPE_CHOICE_FAILED),
        (TYPE_CANCELLED, LABEL_EVENT_TYPE_CHOICE_CANCELLED),
        (TYPE_REFUND_REQUESTED, LABEL_EVENT_TYPE_CHOICE_REFUNED_REQUESTED),
        (TYPE_REFUND_FAILED, LABEL_EVENT_TYPE_CHOICE_REFUND_FAILED),
        (TYPE_REFUND_CANCELLED, LABEL_EVENT_TYPE_CHOICE_REFUND_CANCELLED),
        (TYPE_PARTIALLY_REFUNDED, LABEL_EVENT_TYPE_CHOICE_PARTIALLY_REFUNDED),
        (TYPE_REFUNDED, LABEL_EVENT_TYPE_CHOICE_REFUNDED),
    ]
