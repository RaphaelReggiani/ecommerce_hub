...
class Order(models.Model):
    ...
    PAYMENT_STATUS_CHOICES = [
        ...
        (PAYMENT_STATUS_PROCESSING, LABEL_PAYMENT_PROCESSING),
        ...
        (PAYMENT_STATUS_CANCELLED, LABEL_PAYMENT_CANCELLED),
        (PAYMENT_STATUS_PARTIALLY_REFUNDED, LABEL_PAYMENT_PARTIALLY_REFUNDED),
