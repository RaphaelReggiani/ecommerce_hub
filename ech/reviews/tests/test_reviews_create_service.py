...
from ech.reviews.services.reviews_creation_service import ReviewsCreationService
...
class ReviewsCreationServiceTestCase(
    ...
    @patch(
        "ech.reviews.services.reviews_creation_service.ReviewsLogService.log_review_created"
    )
