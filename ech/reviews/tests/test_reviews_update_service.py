...
from ech.reviews.services.reviews_update_service import ReviewsUpdateService
...
class ReviewsUpdateServiceTestCase(
    ...
    @patch(
        "ech.reviews.services.reviews_update_service.ReviewsLogService.log_review_updated"
    )
